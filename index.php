        ...
        <div class="row" style="min-height: 500px;">
            <div class="col-md-12">
                ...
                <?php 
                    ...
                    $data_atual = date('Y-m-d H:i:s'); // Obtém a data atual
                    ...
                    $posts = buscar(
                        'post',
                        ['titulo', 'data_postagem', 'id', '(select nome from usuario where usuario.id = post.usuario_id) as nome'],
                        $criterio,
                        'data_postagem DESC'
                    );
                ?>
